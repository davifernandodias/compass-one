  ...
  <footer>
        <section id="footerSection">
            ...
            <section class="info-links">
                <div class="info-links-company">
                    <h6>COMPANY</h6>
                    <a href="" class="link-rodape">About</a>
                    <a href="" class="link-rodape">Features</a>
                    <a href="" class="link-rodape">Works</a>
                    <a href="" class="link-rodape">Career</a>
                </div>
                <div class="info-links-company">
                    <h6>HELP</h6>
                    <a href="" class="link-rodape">Customer Support</a>
                    <a href="" class="link-rodape">Delivery Details</a>
                    <a href="" class="link-rodape">Terms & Conditions</a>
                    <a href="" class="link-rodape">Privacy Policy</a>
                </div>
                <div class="info-links-company">
                    <h6>FAQ</h6>
                    <a href="" class="link-rodape">Account</a>
                    <a href="" class="link-rodape">Manege Deliveries</a>
                    <a href="" class="link-rodape">Orders</a>
                    <a href="" class="link-rodape">Payment</a>
                </div>
                <div class="info-links-company">
                    <h6>RESOURCES</h6>
                    <a href="" class="link-rodape">Free eBook</a>
                    <a href="" class="link-rodape">Development Tutorial</a>
                    <a href="" class="link-rodape">How to - Blog</a>
                    <a href="" class="link-rodape">Youtube Playlist</a>
                </div>
            </section>
        ...
        <section class="rodape">
            ...
            <div class="rodape-items">
                ...
                <div class="rodape-badges">
                    <img src="assets/images/icons/footer/footer_card_visa.webp" alt="Visa">
                    <img src="assets/images/icons/footer/footer_card_master_class.webp"alt="MasterCard">
                    <img src="assets/images/icons/footer/footer_card_paypal.webp" alt="PayPal">
                    <img src="assets/images/icons/footer/footer_card_apple.webp" alt="ApplePay">
                    <img src="assets/images/icons/footer/footer_card_playstore.webp" alt="Google Pay">
                </div>
            </div>
        </section>
    </footer>
