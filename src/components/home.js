  ...
  <section id="homeSection">
    <div class="home-content">
      ...
      <div class="banner-mobile-models">
          <img src="../../public/images/banners/star/home_star.webp" class="home-banner-star-left" alt="star-left"/>
          <img src="../../public/images/banners/star/home_star.webp" class="home-banner-star-right" alt="star-right"/>
          <img src="../../public/images/banners/home_banner_molds_mobile.webp" alt="home-banner-mobile-models" class="banner-mobile"  id="bannerMobileModels" />
      </div>
  </section>
  `;
}
